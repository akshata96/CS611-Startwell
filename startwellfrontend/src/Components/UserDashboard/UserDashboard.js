                                                ...
                                                <div className="site-card-wrapper">
                                                    <Row gutter = {16} height={'80%'}>
                                                        ...
                                                        <Row>
                                                            <Col span={24}>
                                                                <br></br>
                                                                <p className="matchStr">{this.state.matchString}</p>
                                                                <Button className="matchBtn" disabled={this.state.matchState} href={"/Matching?token=" + String(this.state.token)}>Match</Button>
                                                            </Col>
                                                        </Row>
                                                        </Col>
                                                    </Row>
